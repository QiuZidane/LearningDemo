...
public class MySendDemo {
	...
	private static final String COUNT_KEY = MySendDemo.class.getName() + ".count";
	private static final int COUNT = Integer.getInteger(COUNT_KEY, 3);

	private static final String READ_TIMEOUT_KEY = MySendDemo.class.getName() + ".readTimeout";
	private static final int READ_TIMEOUT = Integer.getInteger(READ_TIMEOUT_KEY, 10); // [ms]

	private static final String SNAPLEN_KEY = MySendDemo.class.getName() + ".snaplen";
	private static final int SNAPLEN = Integer.getInteger(SNAPLEN_KEY, 65536); // [bytes]

	private static final String TU_KEY = MySendDemo.class.getName() + ".tu";
	private static final int TU = Integer.getInteger(TU_KEY, 4000); // [bytes]

	private static final String MTU_KEY = MySendDemo.class.getName() + ".mtu";
	...
	public static void main(String[] args) throws PcapNativeException {
		...
		String strSrcMacAddress = "30:e3:7a:0a:55:78"; 	// e.g. 12:34:56:ab:cd:ef
		String strDstIpAddress = "116.251.204.42"; 		// for InetAddress.getByName()
		String strDstMacAddress = "a0:63:91:de:6a:c0"; 	// e.g. 12:34:56:ab:cd:ef
	...
	private static class Task implements Runnable {
		...
		public void run() {
			try {
				...
				e.printStackTrace();
			} catch (InterruptedException e) {} catch (NotOpenException e) {
				e.printStackTrace();
			}
		}
